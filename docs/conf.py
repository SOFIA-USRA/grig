...
html_theme_options = {
    'logotext1': 'Grig',  # white,  semi-bold
...
latex_documents = [('index', project + '.tex',
                    r'Grig Documentation',
                    author, 'howto')]
...
linkcheck_retry = 5
linkcheck_ignore = [
    r'https://github\.com/SOFIA-USRA/grig/(?:issues|pull)/\d+',
]
