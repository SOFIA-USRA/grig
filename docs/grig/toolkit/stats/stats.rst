.. currentmodule:: grig.toolkit.stats.stats

Outlier Rejection
-----------------

The :mod:`grig.toolkit.stats.stats` module incorporates outlier rejection in
...
.. plot::
    ...
    from grig.toolkit.stats import find_outliers
...
.. code-block:: python
    ...
    from grig.toolkit.stats import meancomb, medcomb
    import numpy as np
